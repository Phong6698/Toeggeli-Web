...
import { ChangeDetectionStrategy, ChangeDetectorRef, Component, Directive, ElementRef, EventEmitter, HostBinding, HostListener, Inject, Injectable, InjectionToken, Input, LOCALE_ID, NgModule, NgZone, Optional, Output, Pipe, QueryList, Self, SkipSelf, ViewChild, ViewChildren } from '@angular/core';
...
import { MatInput as MatInput$1 } from '@angular/material';
...
__decorate$2([
    ...
    __metadata$2("design:type", CdkPortalOutlet)
...
MatKeyboardContainerComponent = __decorate$2([
    Component({
...
var MatKeyboardService = /** @class */ (function () {
    ...
    MatKeyboardService.prototype._attachKeyboardContent = function (config) {
        ...
        var portal$$1 = new ComponentPortal(MatKeyboardComponent);
...
MatKeyboardService = __decorate$1([
    Injectable(),
    __param$1(2, Inject(LOCALE_ID)),
    __param$1(3, Inject(MAT_KEYBOARD_LAYOUTS)),
    __param$1(4, Optional()), __param$1(4, SkipSelf()),
    __metadata$1("design:paramtypes", [Overlay,
        LiveAnnouncer, String, Object, MatKeyboardService])
], MatKeyboardService);
...
var MatKeyboardKeyComponent = /** @class */ (function () {
    ...
    function MatKeyboardKeyComponent(_deadkeys, _icons) {
        ...
        this.pressed$ = new BehaviorSubject$1(false);
...
MatKeyboardKeyComponent = __decorate$3([
    Component({
    ...
    __param$2(0, Inject(MAT_KEYBOARD_DEADKEYS)),
    __param$2(1, Inject(MAT_KEYBOARD_ICONS)),
...
var MatKeyboardComponent = /** @class */ (function () {
    ...
    function MatKeyboardComponent(_locale, _keyboardService) {
        ...
        this._darkTheme = new BehaviorSubject$1(false);
        this._isDebug = new BehaviorSubject$1(false);
        this._inputInstance$ = new BehaviorSubject$1(null);
...
MatKeyboardComponent = __decorate([
    ...
    __metadata("design:paramtypes", [Object, MatKeyboardService])
...
MatKeyboardDirective = __decorate$4([
    Directive({
...
MatKeyboardKebabCasePipe = __decorate$5([
    Pipe({
...
MatKeyboardModule = __decorate$6([
    NgModule({
        imports: [
            // Angular modules
            CommonModule,
